...
app.use(cors({
  origin: [ process.env.CLIENT_URL, "https://academic-council-portal.vercel.app", "http://localhost:800", "http://localhost:5173", "https://acc.iitp.ac.in", "http://acc.iitp.ac.in", "https://172.16.1.254", "http://172.16.1.254" ],
